...
- Estimate life regained in days or weeks  
...
| Tool                  | Description                            |
|-----------------------|----------------------------------------|
| Flutter               | UI framework for Android and iOS       |
...
1. User Onboarding  
   Set daily cigarette count, cost per cigarette, and other preferences.

2. Daily Input  
   Log the number of cigarettes smoked per day.

3. Auto-Tracking  
   The app calculates nicotine consumption, money saved, and life added.

4. Progress View  
   View progress statistics on a simple, clean dashboard.
...
Sreedhar Janardhan  
Email: sreedharanjanardhan@gmail.com  
